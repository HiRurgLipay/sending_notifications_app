"""
Django settings for sending_notifications_app project.
...
from .logger_formater import ContextFormatter
...
ROOT_URLCONF = "sending_notifications_app.urls"
...
WSGI_APPLICATION = "sending_notifications_app.wsgi.application"
